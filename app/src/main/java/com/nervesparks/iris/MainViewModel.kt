...
//        private val NanosPerSecond = 1_000_000_000.0
    ...
    var allModels by mutableStateOf(
        listOf(
            mapOf(
                "name" to "MiniPal-v1.gguf",
                "source" to "https://huggingface.co/LiteMind/MiniPal-step1-gguf/resolve/main/MiniPal-v1.gguf?download=true",
                "destination" to "MiniPal-v1.gguf"
            ),
